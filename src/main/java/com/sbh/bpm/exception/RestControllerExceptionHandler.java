package com.sbh.bpm.exception;

import java.util.List;
import java.util.Objects;

import com.sbh.bpm.payload.ApiResponse;
import com.sbh.bpm.payload.ExceptionResponse;
import com.sbh.bpm.payload.MessageResponse;
...
public class RestControllerExceptionHandler {
    ...
    public ResponseEntity<ApiResponse> resolveException(RestException exception) {
